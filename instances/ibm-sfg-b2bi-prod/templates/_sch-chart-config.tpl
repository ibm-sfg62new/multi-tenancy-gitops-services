  ...
  chart:
    ...
    components:
      ...
      servicesIntegration:
        ...
        documentServiceName: "document-service"
    config:
    ...
    integrations:
      itx:
        components:
             dataPVC:
                name:  {{ .Values.integrations.itxIntegration.dataPVC.name | default "itxdata" }}
             logsPVC:
                name:  {{ .Values.integrations.itxIntegration.logsPVC.name | default "itxlogs" }}
      itxa:
        prereq:
            job:
              name: "preinstall-itxa-prereq-job" 
            configmap:
              name: "itxa-config"
    labelType: "prefixed"
    metering:
